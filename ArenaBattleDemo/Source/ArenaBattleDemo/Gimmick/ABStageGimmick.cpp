...
void AABStageGimmick::OnConstruction(const FTransform& Transform)
{
    ...
    // OnConstruction이 호출될 때 상태값도 갱신되도록 처리.
...
void AABStageGimmick::OnGateTriggerBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
    ...
    bool Result = GetWorld()->OverlapMultiByObjectType(
        ...
        FQuat::Identity,                                                // 회전.
        FCollisionObjectQueryParams::InitType::AllObjects,              // 충돌 대상 오브젝트 채널.
    ...
    DrawDebugSphere(GetWorld(), NewLocation, 775.0f, 26, DrawColor, false, 1.0f);
...
{
    // 게임의 점수 처리 및 클리어 여부를 확인하기 위해 게임모드 가져오기.
...
void AABStageGimmick::OpponentSpawn()
{
    ...
    // NPC 생성.
    //AActor* OpponentActor = GetWorld()->SpawnActor<AABCharacterNonPlayer>(SpawnLocation, FRotator::ZeroRotator); // 아래와 동일
...
void AABStageGimmick::SpawnRewardBoxed()
{
